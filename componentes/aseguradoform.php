                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data" action="#">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" inputmode="numeric" id="dni_asegurado" name="dni_asegurado" class="form-control" placeholder="" value="<?php echo $txtdni; ?>" aria-label="dni_asegurado" aria-describedby="dni_asegurado">
                                            ...
                                            <div class="form-group row">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select id="tipoiva_asegurado" name="tipoiva_asegurado" value="<?php echo $txtiva; ?>" class="form-select" id="tipoiva_asegurado">
                                                        ...
                                                        <option value="1" <?php echo ($txtiva == 1) ? 'selected' : '' ?>> Responsable Inscripto</option>
                                                        <option value="2" <?php echo ($txtiva == 2) ? 'selected' : '' ?>>Responsable no Inscripto</option>
                                                        <option value="3" <?php echo ($txtiva == 3) ? 'selected' : '' ?>>IVA no Responsable</option>
                                                        <option value="4" <?php echo ($txtiva == 4) ? 'selected' : '' ?>>IVA Sujeto Exento</option>
                                                        <option value="5" <?php echo ($txtiva == 5) ? 'selected' : '' ?>>Consumidor Final</option>
                                                        <option value="6" <?php echo ($txtiva == 6) ? 'selected' : '' ?>>Monotributo</option>
                                                        <option value="7" <?php echo ($txtiva == 7) ? 'selected' : '' ?>>Sujeto no Categorizado</option>
                                                        <option value="8" <?php echo ($txtiva == 8) ? 'selected' : '' ?>>Proveedor del Exterior</option>
                                                        <option value="9" <?php echo ($txtiva == 9) ? 'selected' : '' ?>>Cliente del Exterior</option>
                                                        <option value="10" <?php echo ($txtiva == 10) ? 'selected' : '' ?>>IVA Liberado – Ley Nº 19.640</option>
                                                        <option value="11" <?php echo ($txtiva == 11) ? 'selected' : '' ?>>IVA Responsable Inscripto – Agente de
                                                            Percepción
                                                        </option>
                                                ...
                                                <tbody>
                                                    <?php foreach ($listaAsegurados as $Asegurado) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form method="POST" enctype="multipart/form-data" action="aseguradoeditarmodal.php">
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data" action="#">
                                    ...
                                    <div class="form-group row">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="domicilio_asegurado">Domicilio</span>
                                            <input type="text" id="domicilio_asegurado" name="domicilio_asegurado" class="form-control" placeholder="" value="<?php echo $txtapellido; ?>" aria-label="domicilio_asegurado" aria-describedby="domicilio_asegurado">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="input-group mb-3">
                                    ...
                                    <div class="form-group row">
                                        <div class="input-group mb-3">
                                            ...
                                            <span class="input-group-text" id="cuit_asegurado">C.U.I.T.</span>
                                            <input type="text" id="cuit_asegurado" name="cuit_asegurado" class="form-control" placeholder="99-99999999-9" aria-label="cuit_asegurado" aria-describedby="cuit_asegurado">
                                        </div>
                                    </div>
                                    <div class="col-md-12 ">
                                        <button type="submit" name="accion" value="Agregar" class="btn btn-primary">
