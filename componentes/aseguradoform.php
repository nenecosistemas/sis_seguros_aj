...
<body>
    <div class="col-md-12 justify-content-center" id="Normalpage">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" action="#">
                                            <div class="form-group row">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" inputmode="numeric" id="dni_asegurado"
                                                    ...
                                                    <input type="text" id="apellido_y_nombre_asegurado"
                                                        name="apellido_y_nombre_asegurado" class="form-control"
                                                        placeholder="" value="<?php echo $txtapellido; ?>"
                                            ...
                                            <div class="form-group row">
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text"
                                                        id="domicilio_asegurado">Domicilio</span>
                                                    <input type="text" id="domicilio_asegurado"
                                                        name="domicilio_asegurado" class="form-control" placeholder=""
                                                        value="<?php echo $txtdomicilio; ?>"
                                                        aria-label="domicilio_asegurado"
                                            ...
                                            <div class="form-group row">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="email" id="correo_asegurado" name="correo_asegurado"
                                                        class="form-control" placeholder=""
                                                        value="<?php echo $txtcorreo; ?>" aria-label="email_asegurado"
                                            ...
                                            <div class="form-group row">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select id="tipoiva_asegurado" name="tipoiva_asegurado"
                                                        value="<?php echo $txtiva; ?>" class="form-select"
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <button type="cancel" name="accion" value="Cancelar"
                                                    class="btn btn-info">
                                                    Cancelar
        ...
        <?php include "aseguradoeditarmodal.php"; ?>
</body>
