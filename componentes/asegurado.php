                            ...
                            <form method="POST" enctype="multipart/form-data" action="#">
                                <div class="form-group row">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="dni_asegurado" name="dni_asegurado" class="form-control" placeholder="" aria-label="dni_asegurado" aria-describedby="dni_asegurado">
                                ...
                                <div class="col-md-12 ">
                                    <button type="submit" name="accion" value="Agregar" class="btn btn-primary"> Grabar Asegurado <i class="fa-solid fa-save"></i></button>
                                    <button type="cancel" name="accion" value="Cancelar" class="btn btn-info"> Cancelar <i class="fa-solid fa-save"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
